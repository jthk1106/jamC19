      ...
      <React.Fragment>
        ...
        <div className="row justify-content-around">
            ...
            <div className="card-body">
                ...
                <div className="row justify-content-between cardRow">
                    <div>New Cases Today</div>
                    <div>{this.state.ca.todayCases}</div>
                </div>
                <div className="row justify-content-between cardRow">
                    <div>Total Cases</div>
                    <div>{this.state.ca.cases}</div>
                </div>
                <div className="hr"></div>
                <div className="row justify-content-between cardRow">
                    <div>Deaths Today</div>
                    <div>{this.state.ca.todayDeaths}</div>
                </div>
                <div className="row justify-content-between cardRow">
                    <div>Total Deaths</div>
                    <div>{this.state.ca.deaths}</div>
                </div>
                <div className="hr"></div>
                <div className="row justify-content-between cardRow">
                    <div>Total Tested</div>
                    <div>{this.state.ca.tests}</div>
                </div>
                <div className="row cardRow">
                    <div className="container">
                    <div className="row justify-content-between">
                        <div>Tested Per Million</div>
                        <div>{this.state.ca.testsMillion}</div>
                    </div>
                    <div className="row justify-content-end">
                        <div>({caTestsPercent.toFixed(3)}%)</div>
                    </div>
                    </div>
                </div>
                <div className="hr"></div>
